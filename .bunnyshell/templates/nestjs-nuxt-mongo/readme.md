...
This Environment [Template](https://documentation.bunnyshell.com/docs/templates-what-are-templates) is a boilerplate for creating a new environment based on a stack using Node.js with NestJS for the backend, Nuxt with Typescript for the frontend and MongoDB as the database.
